...
<div id="content_js" style="display:none;">
    ...
    head: [['N°', 'Objet', 'Désignation', 'Qté', 'Prix U HT', 'Total HT']],
    ...
    body: [
    <% if (data.get("totalttc").length() > 0) { %>
    ['Montant du bon de commande arrété a la somme de :']
    <% } %>
    ],
    ...
    //headStyles: {fillColor: [244, 67, 54],halign: 'left'},
    //headStyles: {fillColor: [41, 218, 96],halign: 'left'},
    headStyles: {fillColor: [255, 255, 255],halign: 'left'},
    Styles: {fillColor: [255, 255, 255],halign: 'left'},
    footStyles: {textColor: [255,255,255],halign: 'left',cellWidth:30},
    body: [['DA ouvert: ',' <%= data.get("ouvert")%>'],
    ['DA montant: ',' <%= data.get("montant")%>']],
    margin: { top: 56,bottom: 30,left:7,right:145,width: 100},
    })
    doc.autoTable({
    headStyles:{fillColor: [255, 255, 255],textColor: [40],fontStyle: 'normal',halign: 'left',cellWidth:70,minCellHeight:20,valign:'bottom'},
    head: [['Biskra le : ','','Biskra le : ','<%=date%>']],
    footStyles: {fillColor: [255, 255, 255],textColor: [40],halign: 'left',cellWidth:70},
    foot: [['Signature du chef de structure ','','Signature du Gérent ']],
    margin: { top: 56,bottom: 30,left:7,right:5,width: 100},
    })
