...
<%
    ...
    if (tablename.equals("Produit")) {
        attributs = "manage%%N°%%Material%%Marque%%Modele%%Quantité%%Prix unitaire%%Structure%%ProduitDe";
        attributsTotal = "Material%%Designation%%Matricule%%Type%%ProduitDe%%Marque%%Modele%%Prix-unitaire%%Structure%%Image";
        attributsEdit = "Material%%Designation%%Matricule%%Type%%ProduitDe%%Marque%%Modele%%Prix-unitaire%%Structure";
        attributsinput = "text%%text%%text%%text%%ProduitDe%%text%%text%%number%%Structure%%file";
        attributsinputEdit = "text%%text%%text%%text%%ProduitDe%%text%%text%%number%%Structure";
    ...
    if (tablename.equals("Article")) {
        ...
        String[] list_structure = new String[1];
        ...
        <div id="mdl-table" class="col-md-12 card material-table">
            <div class="col-md-12" style="padding: 10px 5px;">
                <div class="row">
                    ...
                    <div class="col-md-1 text-right"> 
                        <label style="color: #03a9f3;" class="filter-toggle btn-flat nopadding mdl-button mdl-js-button mdl-button--icon" data-toggle="collapse" href="#collapseExample2" aria-expanded="false" aria-controls="collapseExample">
                ...
                <div class="collapse" id="collapseadd<%=tablename%>">
                    <div class="card card-body">
                        <div class="modal-body">  
                            <% System.out.println("rrrrfffdfgdfg");%> 
...
<script>
    ...
    switch (tablename2<%=tablename%>) {
        case "Produit":
            ...
            autocomplete(document.getElementById("edit<%=tablename%>").querySelector("#Type-<%=tablename%>"), types);

            //All variable of Table 
            variable<%=tablename%> = ["Material", "Designation", "Matricule", "Type", "ProduitDe", "Marque", "Modele", "Prix-unitaire", "Structure", "Image"];
            // GET Variable from modal EDIT
            variableEditGet<%=tablename%> = ["Material", "Designation", "Matricule", "Type", "ProduitDe", "Marque", "Modele", "Prix-unitaire", "Structure"];
            // Variables Afficher dans la Table
            variableTable<%=tablename%> = ["Material", "Marque", "Modele", "Quantité", "Prix-unitaire", "Structure", "ProduitDe"];
            ...
            variableEdit<%=tablename%> = ["Material", "Marque", "Modele", "Prix-unitaire", "Structure", "ProduitDe"];
        ...
        switch ($(this).text()) {
            ...
            case "ÉDITER":
                ...
                for (i = 0; i < variableEdit<%=tablename%>.length; i++) {
                    ...
                    //alert(variableEdit<%=tablename%>[i]);
                    //alert(v1);
